...
ns:RegisterModule({
    ...
    label = "Auto Repair",
    options = {
        { key = "autoRepair", label = "Auto repair at vendors", default = true,
          tooltip = "Repair all your gear as soon as a vendor that can repair opens. Hold Shift while opening the vendor to skip." },
        { key = "autoRepairGuild", label = "Use guild bank funds when allowed", default = false, parent = "autoRepair",
          tooltip = "Pay with guild bank money when your guild rank allows it and the daily allowance covers the cost. Falls back to your own money otherwise." },
